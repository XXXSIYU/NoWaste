...
public class ProductHelper {
    ...
    public JSONObject getAll() {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "SELECT * FROM `nowaste`.`tbl_food`";
            ...
            while(rs.next()) {
                ...
                p = new Product(product_id, name, price, image, describe, address, exp , if_raw, food_seller_id, stock);
    ...
    public JSONObject getByIdList(String data) {
      ...
      try {
          ...
          /** SQL指令 */
          String sql = "SELECT * FROM `nowaste`.`tbl_food` WHERE `tbl_food`.`id`";
    ...
    public Product getById(String id) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `nowaste`.`tbl_food` WHERE `tbl_food`.`id` = ? LIMIT 1";
    ...
    public JSONObject create(Product m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "INSERT INTO `nowaste`.`tbl_food`(`name`, `if_raw`,`price`,`describe`,"
            		+ " `exp`,`image`,`food_seller_id`,`stock`,`address`,`id`)"
                    + " VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
