...
public class MemberHelper {
    ...
    public JSONObject deleteByID(int id) {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "DELETE FROM `nowaste`.`tbl_member` WHERE `id` = ? LIMIT 1";
    ...
    public JSONObject getAll() {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `nowaste`.`tbl_member`";
            ...
            while(rs.next()) {
                ...
                m = new Member(member_id, phone, password, name, seller, address, create_datetime);
    ...
    public JSONObject getByID(String id) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `nowaste`.`tbl_member` WHERE `id` = ? LIMIT 1";
    ...
    public boolean checkDuplicate(Member m){
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT count(*) FROM `nowaste`.`tbl_member` WHERE `phone` = ?";
    ...
    public JSONObject create(Member m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "INSERT INTO `nowaste`.`tbl_member`(`name`, `phone`, `password`, `modified`, `created`, `seller`)"
                    + " VALUES(?, ?, ?, ?, ?, ?, ?)";
    ...
    public JSONObject update(Member m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "UPDATE `tbl_member` SET `name`= ? ,`address`= ? ,"+
            "`password`= ? ,`phone`= ? ,`seller`= ?  WHERE `id` = ? ";
            /** 取得所需之參數 */
            String name = m.getName();
            String address = m.getAddress();
            String phone = m.getphone();
            String password = m.getPassword();
            String seller = String.valueOf(m.getseller() ? 1 : 0);
    ...
    public void updateLoginTimes(Member m) {
        /** 更新時間之分鐘數 */
        String new_times = m.getcreate_datetime();
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `nowaste`.`tbl_member` SET `create_datetime` = ? WHERE `id` = ?";
            /** 取得會員編號 */
            int id = m.getID();
     ...
     */
    public void updateStatus(Member m, Boolean seller) {      
        /** 記錄實際執行之SQL指令 */
        String exexcute_sql = "";
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `nowaste`.`tbl_member` SET `seller` = ? WHERE `id` = ?";
            /** 取得會員編號 */
            int id = m.getID();
            
            /** 將參數回填至SQL指令當中 */
            pres = conn.prepareStatement(sql);
            pres.setBoolean(1, seller);
            pres.setInt(2, id);
            /** 執行更新之SQL指令 */
            pres.executeUpdate();
