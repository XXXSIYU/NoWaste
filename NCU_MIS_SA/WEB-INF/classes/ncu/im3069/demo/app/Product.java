...
public class Product {
     ...
     * @param image 產品圖片
     */
	public Product(int id, String name, double price, String image, String address, Date exp, boolean if_raw, int food_seller_id, int stock) {
		this.id = id;
		this.name = name;
		this.price = price;
		this.image = image;
     ...
     * @param describe 產品敘述
     */
	public Product(int id, String name, double price, String image, String address, String describe, Date exp, boolean if_raw, int food_seller_id, int stock) {
		this.id = id;
		this.name = name;
		this.price = price;
		this.image = image;
