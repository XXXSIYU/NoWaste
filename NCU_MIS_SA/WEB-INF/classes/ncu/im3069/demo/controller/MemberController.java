...
public class MemberController extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String create_datetime = jso.getString("create_datetime");
        Boolean seller = jso.getBoolean("seller");
        String address = jso.getString("address");
        
        
        /** 建立一個新的會員物件 */
        Member m = new Member(member_id, phone, password, name, seller, address, create_datetime);
